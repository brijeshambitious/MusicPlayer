package com.brijesh.musicplayer.Service;
...
import com.brijesh.musicplayer.SongListActivity;

public class MusicService extends Service implements AudioManager.OnAudioFocusChangeListener{
	String LOG_CLASS = "MusicService";
	public static MediaPlayer mp;
	int NOTIFICATION_ID = 1111;
	public static final String NOTIFY_PREVIOUS = "com.brijesh.musicplayer.previous";
	public static final String NOTIFY_DELETE = "com.brijesh.musicplayer.delete";
	public static final String NOTIFY_PAUSE = "com.brijesh.musicplayer.pause";
	public static final String NOTIFY_PLAY = "com.brijesh.musicplayer.play";
	public static final String NOTIFY_NEXT = "com.brijesh.musicplayer.next";
